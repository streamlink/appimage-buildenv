...
install_yq() {
  local python=/opt/python/cp314-cp314/bin/python
...
#    uv pip compile --python /opt/python/cp314-cp314/bin/python --generate-hashes /dev/stdin
argcomplete==3.7.0 \
    --hash=sha256:afde224f753f874807b1dc1414e883ab8fe0cda9c04807b6047dcb8e1ac23913 \
    --hash=sha256:d8f0f22d2a8a7caa383be1e22b6caf1ecaf0ebd10d8f83cc125e36540c95830c
    # via yq
pyyaml==6.0.3 \
...
xmltodict==1.0.4 \
    ...
    # via yq
yq==4.1.1 \
    --hash=sha256:4c08e09a617c33fa3dcbc50fe9dd4d2c66a06f7391f1caa10bd3c6039d9fbef0 \
    --hash=sha256:ab3fc344dc4a39d833d328f080a6e794c1cb7243b05c0076ac1edce3d22caabd
    # via -r dev/stdin
EOF
